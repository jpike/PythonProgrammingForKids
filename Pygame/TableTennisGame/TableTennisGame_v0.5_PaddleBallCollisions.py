## Version 0.5 of a video game version of "table tennis"
## (https://en.wikipedia.org/wiki/Table_tennis).
## This version builds upon the previous version by adding support for checking for
## collisions between the player paddles and the ball.
