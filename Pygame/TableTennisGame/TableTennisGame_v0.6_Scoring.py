## Version 0.6 of a video game version of "table tennis"
## (https://en.wikipedia.org/wiki/Table_tennis).
## This version builds upon the previous version by adding support for basic scoring
## of points, with scores printed out via text to the console.
...
while True:
    ...
    if ball_outside_of_screen_left_boundary:
        ...
        print("Right player scored!  Right player score = " + str(right_player_score))
        ...
        print("Left player scored!  Left player score = " + str(left_player_score))
