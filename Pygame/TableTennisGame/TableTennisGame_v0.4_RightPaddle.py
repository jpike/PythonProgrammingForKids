## Version 0.4 of a video game version of "table tennis"
## (https://en.wikipedia.org/wiki/Table_tennis).
## This version builds upon the previous version by adding a right player paddle with
## all of the same features as the left paddle.
