...
enemy_x = 0
enemy_y = 200
enemy_movement_velocity_in_pixels_per_second = 100
...
while True:
    ...
    if enemy_moved_off_left_or_right_side_of_screen:
        enemy_movement_velocity_in_pixels_per_second *= -1
    enemy_movement_amount_in_pixels = (
        enemy_movement_velocity_in_pixels_per_second
        *
        time_elapsed_since_last_frame_in_seconds)
    enemy_x += enemy_movement_amount_in_pixels
